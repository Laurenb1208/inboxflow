...
const SAMPLE_EMAILS = [
  ...
  { id: 'e37', fromName: 'Nadia Osei',         fromAddr: 'nadia@company.com',       subject: 'Meeting recap: sales strategy session',          snippet: 'Here is the recap from our meeting this morning. Three action items are assigned — see the doc for details.',       receivedAt: '2026-04-16T15:00:00Z' },
  { id: 'e38', fromName: 'Google Calendar',    fromAddr: 'calendar-noreply@google.com', subject: 'Invitation: UX review — Apr 25 at 2 PM',    snippet: 'You have been invited to "UX Review" on Friday, April 25 at 2:00 PM. Accept or decline in your calendar.',         receivedAt: '2026-04-16T10:00:00Z' },
  ...
  { id: 'e40', fromName: 'People Ops',         fromAddr: 'people@company.com',      subject: 'Invite: company offsite planning session',       snippet: 'You\'re invited to join the offsite planning meeting on April 29. Please RSVP via the calendar invite by Friday.',   receivedAt: '2026-04-14T11:00:00Z' },
  { id: 'e41', fromName: 'Stephanie Yu',       fromAddr: 'syu@company.com',         subject: 'Reschedule: 1:1 moved to Wednesday 4 PM',        snippet: 'Hi — I need to reschedule our 1:1 to Wednesday at 4 PM. I\'ll update the calendar invite now. Does that work?',     receivedAt: '2026-04-13T09:00:00Z' },
  ...
  { id: 'e42', fromName: 'Apex Consulting',    fromAddr: 'hello@apexco.com',        subject: 'Follow-up: partnership proposal sent last week',  snippet: 'Just following up on the partnership proposal I sent over last Tuesday. Happy to jump on a call to answer questions.', receivedAt: '2026-04-15T16:00:00Z' },
  ...
  { id: 'e44', fromName: 'Bloom Agency',       fromAddr: 'projects@bloomagency.co', subject: 'Final deliverable: brand refresh assets',         snippet: 'All deliverables for the brand refresh project are now complete and uploaded to the shared drive. Please review.',    receivedAt: '2026-04-13T11:30:00Z' },
  { id: 'e45', fromName: 'Nexus Procurement',  fromAddr: 'ap@nexuscorp.com',        subject: 'Invoice #2209 overdue — please advise',           snippet: 'Our records show Invoice #2209 ($6,500) is 15 days past due. Please confirm payment status or let us know if there is an issue.', receivedAt: '2026-04-11T09:00:00Z' },
  { id: 'e46', fromName: 'Pinnacle Group',     fromAddr: 'bd@pinnaclegroup.com',    subject: 'Updated proposal with revised scope of work',     snippet: 'Based on our last call, I have updated the proposal to reflect the reduced scope. Please review and let me know your thoughts.', receivedAt: '2026-04-09T15:00:00Z' },
  ...
  { id: 'e47', fromName: 'People Ops',         fromAddr: 'people@company.com',      subject: 'Reminder: performance reviews open this week',   snippet: 'Just a reminder that the self-evaluation portal is open until Sunday. Please complete your review before it closes.',  receivedAt: '2026-04-16T08:30:00Z' },
  { id: 'e48', fromName: 'Office Manager',     fromAddr: 'office@company.com',      subject: 'FYI — kitchen fridge cleaned out Thursday',      snippet: 'Team FYI: the office kitchen fridge will be cleaned out Thursday afternoon. Please remove any personal items by noon.', receivedAt: '2026-04-15T10:00:00Z' },
  { id: 'e49', fromName: 'Design Team',        fromAddr: 'design@company.com',      subject: 'Internal update: Figma org restructure done',    snippet: 'Internal update: the Figma workspace has been reorganized by product area. See the pinned message in #design for details.', receivedAt: '2026-04-14T14:00:00Z' },
  { id: 'e50', fromName: 'Security Team',      fromAddr: 'security@company.com',    subject: 'Reminder: complete security awareness training',  snippet: 'Team reminder: mandatory security awareness training must be completed by April 30. Link to the portal is in this email.', receivedAt: '2026-04-12T09:00:00Z' },
  { id: 'e51', fromName: 'Ryan Castillo',      fromAddr: 'ryan@company.com',        subject: 'Update: onboarding checklist for new hires',     snippet: 'Quick update — the new hire onboarding checklist has been revised. Please use the updated version starting next week.', receivedAt: '2026-04-10T11:00:00Z' },
  { id: 'e52', fromName: 'Product Team',       fromAddr: 'product@company.com',     subject: 'FYI: v3.0 launch date moved to May 12',          snippet: 'FYI the v3.0 release has been moved from May 5 to May 12 to allow more time for QA. Internal announcement going out Monday.', receivedAt: '2026-04-08T13:30:00Z' },
  { id: 'e53', fromName: 'Legal',              fromAddr: 'legal@company.com',       subject: 'Internal: updated NDA template now in Drive',    snippet: 'Internal notice: the standard NDA template has been updated by our legal team. Please use the new version for all new vendors.', receivedAt: '2026-04-07T10:00:00Z' },
  ...
  { id: 'e35', fromName: 'Flight Confirm',     fromAddr: 'confirm@flightapp.com',   subject: 'Flight confirmation: ORD → JFK Apr 28',          snippet: "Your flight UA2284 from Chicago O'Hare to New York JFK on April 28 at 7:15 AM is confirmed. Check in opens 24h before.", receivedAt: '2026-04-18T15:00:00Z' },
  ...
  { id: 'e54', fromName: 'Notion',             fromAddr: 'notify@notion.so',        subject: 'Someone shared a page with you',                 snippet: 'Jordan Rivera shared "2026 Company Wiki" with you. Click to open the page and start reading.',                          receivedAt: '2026-04-16T16:00:00Z' },
  { id: 'e55', fromName: 'Figma',              fromAddr: 'noreply@figma.com',       subject: 'New comment on "Dashboard v4"',                  snippet: 'Alex left a comment on your design file: "Can we try a darker shade on the sidebar?" Click to reply.',                  receivedAt: '2026-04-15T11:00:00Z' },
  { id: 'e56', fromName: 'Airbnb',             fromAddr: 'automated@airbnb.com',    subject: 'Your reservation is confirmed — San Francisco',  snippet: 'Your stay at "Bright Studio Near Union Square" from May 6–9 is confirmed. Check-in instructions will arrive 48h before.', receivedAt: '2026-04-14T09:00:00Z' },
  { id: 'e57', fromName: 'Coursera',           fromAddr: 'no-reply@coursera.org',   subject: 'Your certificate is ready to download',         snippet: 'Congratulations! You have earned your certificate for "Data Analysis with Python." Download and share it on LinkedIn.',    receivedAt: '2026-04-12T14:00:00Z' },
  { id: 'e58', fromName: 'Dropbox',            fromAddr: 'no-reply@dropbox.com',    subject: 'New shared folder: Q1 Assets',                  snippet: 'Morgan shared the folder "Q1 Assets" with you. You can now view and edit the files inside. Open in Dropbox.',            receivedAt: '2026-04-11T10:30:00Z' },
  { id: 'e59', fromName: 'Spotify',            fromAddr: 'noreply@spotify.com',     subject: 'Your April Wrapped is here',                    snippet: 'You\'ve listened to 47 hours of music this month. Your top artist was Khruangbin. See your full April stats inside.',     receivedAt: '2026-04-10T08:00:00Z' },
  { id: 'e60', fromName: 'App Store',          fromAddr: 'no_reply@email.apple.com', subject: 'Your receipt from Apple',                      snippet: 'Thank you for your purchase of "1Password - Password Manager" — $2.99/month. View full receipt in your Apple ID account.', receivedAt: '2026-04-08T07:00:00Z' },
]
